...
<button type="button" onclick="calculateTotal()">Calculate Total</button> <br><br> <button type="submit" onclick="setTotal()">Proceed to Payment</button>
...
function calculateTotal() {
    let total =
        parseInt(document.getElementById("pizza").value) +
        parseInt(document.getElementById("burger").value) +
        parseInt(document.getElementById("pasta").value) +
